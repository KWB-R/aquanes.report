---
title: "Automated report for Berlin Tiefwerder"
output:
  html_document:
    fig_height: 7
    fig_width: 12
...
thresholds_file <- system.file("shiny/berlin_t/data/thresholds.csv",
...
### Raw data
dat <- aquanes.report::import_data_berlin_t()
...
input <- list(report_sitenames = unique(dat$SiteName),
              ...
              report_daterange = c("2017-06-01", "2017-06-30"),
              report_timezone = "CET")
