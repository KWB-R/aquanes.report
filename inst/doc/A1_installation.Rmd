...
workflow for installing the [R package aquanes.report](#1-2-r-package-installation) 
is described.
...
package **aquanes.report** R 3.3.2 was used. However, also later R releases 
...
"aquanes.report" from Github. Installation is done by executing the following 
...
parameter "ref", which needs to be set to a valid release (check here: [releases](https://github.com/KWB-R/aquanes.report/releases)) by running the following code in R(Studio). This tutorial at least requires release version [v.0.4.0](https://github.com/KWB-R/aquanes.report/releases/tag/v.0.4.0)):
```r
...
***Please cite [v.0.4.0](https://github.com/KWB-R/aquanes.report/releases/tag/v.0.4.0) 
...
“aquanes.report” was installed on your computer:
```{r eval = FALSE}
...
"C:/Users/YOUR_USERNAME/Documents/R/win-library/3.3/aquanes.report""

## 1.2.4	Step 4) Copy site specific files
Knowing the installation folder of the “aquanes.report” package is important, 
...
"C:/Users/YOUR_USERNAME/Documents/R/win-library/3.3/aquanes.report/shiny/haridwar"
...
In this example (which is based on the R 3.3.2 release) it will be located in 
your personal documents folder under:
"C:/Users/YOUR_USERNAME/Documents/R/win-library/3.3/aquanes.report/shiny/haridwar/data"
